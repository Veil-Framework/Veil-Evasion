...
def selfcontained_patch():
    if os.path.exists(settings.METASPLOIT_PATH + "/vendor/bundle/ruby/1.9.1/gems/meterpreter_bins-0.0.12/meterpreter/metsrv.x86.dll"):
        metsrvPath = settings.METASPLOIT_PATH + "/vendor/bundle/ruby/1.9.1/gems/meterpreter_bins-0.0.12/meterpreter/metsrv.x86.dll"
    else:
